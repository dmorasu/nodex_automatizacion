...
import { appendToURLPath, setURLParameter, truncatedISO8061Date, extractConnectionStringParts, getShareNameAndPathFromUrl, appendToURLQuery, httpAuthorizationToString, setURLPath, setURLQueries, EscapePath, ConvertInternalResponseOfListFiles, ConvertInternalResponseOfListHandles, assertResponse, removeEmptyString, asSharePermission, parseOctalFileMode, toOctalFileMode, setUploadChecksumParameters, } from "./utils/utils.common.js";
...
import { StorageCRC64Calculator, structuredMessageDecodingBrowser, structuredMessageDecodingStream, } from "@azure/storage-common";
/**
...
export class ShareFileClient extends StorageClient {
    ...
    async create(size, options = {}) {
        ...
        return tracingClient.withSpan("ShareFileClient-create", options, async (updatedOptions) => {
            ...
            if (options.content !== undefined) {
                ...
                const createChecksumBody = await setUploadChecksumParameters(options.content, options.contentLength, parameters, options, this.shareClientConfig?.uploadContentChecksumAlgorithm);
    ...
    async download(offset = 0, count, options = {}) {
        return tracingClient.withSpan("ShareFileClient-download", options, async (updatedOptions) => {
            ...
            const contentLength = contentChecksumAlgorithm === "StorageCrc64"
    ...
    async uploadRange(body, offset, contentLength, options = {}) {
        return tracingClient.withSpan("ShareFileClient-uploadRange", options, async (updatedOptions) => {
            ...
            const uploadBodyParameters = await setUploadChecksumParameters(body, contentLength, parameters, options, this.shareClientConfig?.uploadContentChecksumAlgorithm);
            parameters.body = uploadBodyParameters.body;
            return assertResponse(await this.context.uploadRange(rangeToString({ count: contentLength, offset }), "update", uploadBodyParameters.contentLength, parameters));
        });
    }
    /**
