...
function getCoreClientOptions(pipeline) {
  ...
  if (!corePipeline) {
    ...
    corePipeline = (0, import_core_client.createClientPipeline)({
      ...restOptions,
      loggingOptions: {
        additionalAllowedHeaderNames: import_constants.StorageFileLoggingAllowedHeaderNames,
        additionalAllowedQueryParameters: import_constants.StorageFileLoggingAllowedQueryParameters,
