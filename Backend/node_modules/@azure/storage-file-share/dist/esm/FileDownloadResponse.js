...
export class FileDownloadResponse {
    ...
    constructor(originalResponse, getter, offset, count, options = {}) {
        this.originalResponse = assertResponse(originalResponse);
        const bodyStream = this.originalResponse.structuredBodyType
            ? structuredMessageDecodingStream(this.originalResponse.readableStreamBody, {})
            : this.originalResponse.readableStreamBody;
        this.fileDownloadStream = new RetriableReadableStream(bodyStream, getter, offset, count, options);
    }
}
