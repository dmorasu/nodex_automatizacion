...
__export(constants_exports, {
  DEFAULT_HIGH_LEVEL_CONCURRENCY: () => DEFAULT_HIGH_LEVEL_CONCURRENCY,
  DEFAULT_MAX_DOWNLOAD_RETRY_REQUESTS: () => DEFAULT_MAX_DOWNLOAD_RETRY_REQUESTS,
  ETagAny: () => ETagAny,
  ETagNone: () => ETagNone,
  FILE_MAX_SIZE_BYTES: () => FILE_MAX_SIZE_BYTES,
  FILE_RANGE_MAX_SIZE_BYTES: () => FILE_RANGE_MAX_SIZE_BYTES,
  FileAttributesNone: () => FileAttributesNone,
  FileAttributesPreserve: () => FileAttributesPreserve,
  ...
  StorageFileLoggingAllowedHeaderNames: () => StorageFileLoggingAllowedHeaderNames,
  StorageFileLoggingAllowedQueryParameters: () => StorageFileLoggingAllowedQueryParameters,
